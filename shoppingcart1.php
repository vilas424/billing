...
<title>Shopping Cart</title><meta name="keywords" content=", Retail shop, website templates, CSS, HTML" />
...
<input type="hidden" name="command" />
 <div id="templatemo_content">
    ...
    <input type="button" value="Continue Shopping" onclick="window.location='products1.php'" />
    </div>
    	...
    	<?php
			...
			?>
				<tr bgcolor="#be457c"><td><b>Order Total: $<?php echo get_order_total()?></b></td><td colspan="5" align="right"><input type="button" value="Clear Cart" onclick="clear_cart()"><input type="button" value="Update Cart" onclick="update_cart()"><input type="button" value="Place Order" onclick="window.location='billing.php'"></td></tr>
			<?php
            }
			else{
