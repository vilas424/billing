...
<div id="templatemo_content">
    ...
    <input type="button" value="Continue Shopping" onclick="window.location='productsd.php'" />
    </div>
    	...
    	<?php
			...
			?>
				<tr bgcolor="#811044"><td><b>Order Total: $<?php echo get_order_total()?></b></td><td colspan="5" align="right"><input type="button" value="Clear Cart" onclick="clear_cart()"><input type="button" value="Update Cart" onclick="update_cart()"><input type="button" value="Place Order" onclick="window.location='billing1.php'"></td></tr>
			<?php
            }
			else{
